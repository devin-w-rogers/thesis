...
export function AboutMe() {
    return(
        <body class="aboutMe" id="aboutMe">
            <p class="aboutText" id="aboutText"> Having recently graduated from Carthage College,</p>
...
/* Having recently graduated from Carthage College, I am looking forward to applying
                ...
                I am a quick learner because I genuinely enjoy improving myself in every way possible. */